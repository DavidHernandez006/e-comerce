...
function createCardHTML(p) {
    ...
    return `
        <div class="col-6 col-md-4 col-lg-3">
            <div class="card card-lumina h-100 overflow-hidden shadow-sm border-secondary">
                <div class="position-relative">
                    ...
                    <button class="btn btn-sm position-absolute top-0 end-0 m-2" onclick="toggleFav(${p.id})">
                ...
                <div class="card-body d-flex flex-column p-3">
                    ...
                    <button class="btn btn-lumina btn-sm w-100" onclick="addToCart(${p.id})">
